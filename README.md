...
- Once you have the case management functions imported, you can add them to your `build_camp()` function. We'll use `add_treatment_seeking()`, specifically - this function passes all of the important parameters for case management to our broader campaign file. There is a small set of parameters that we commonly use, below, but to see all of the available controls you can explore the [source code](https://emod.idmod.org/emodpy-malaria/autoapi/emodpy_malaria/campaign/intervention_systems/).
    ...
    - `drug`: indicates which drugs are to be used for case management. Artemether and Lumefantrine are the default, but all available drugs are defined in emodpy-malaria's [`malaria_drug_params`](https://github.com/EMOD-Hub/emodpy-malaria/blob/main/emodpy_malaria/malaria_drug_params.csv)
...
- Check out some of the other [interventions](https://emod.idmod.org/emodpy-malaria/emod/parameter-campaign-individual-interventions/) in emodpy-malaria. [Drug campaigns](https://emod.idmod.org/emodpy-malaria/autoapi/emodpy_malaria/campaign/intervention_systems/), [ITNs](https://emod.idmod.org/emodpy-malaria/autoapi/emodpy_malaria/campaign/individual_intervention/), and [IRS](https://emod.idmod.org/emodpy-malaria/autoapi/emodpy_malaria/campaign/individual_intervention/) may be of particular interest. 
